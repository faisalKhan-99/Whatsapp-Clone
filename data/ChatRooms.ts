...
export default [{ // created both data files to test the chats we just made
    id: '1',
    users: [{
      id: 'u1',
      name: 'Vadim',
    ...
    users: [{
      ...
      id: 'u4',
      name: 'Alex',
      imageUri: 'https://homepages.cae.wisc.edu/~ece533/images/girl.png',
    }],
    lastMessage: {
      id: 'm3',
      content: 'Hi, Vadim.',
    ...
    users: [{
      ...
      id: 'u6',
      name: 'Elon Musk',
      imageUri: 'https://homepages.cae.wisc.edu/~ece533/images/watch.png',
    }],
    lastMessage: {
      id: 'm5',
    ...
    users: [{
      ...
      id: 'u7',
      name: 'Adrian',
      imageUri: 'https://homepages.cae.wisc.edu/~ece533/images/tulips.png',
    }],
    lastMessage: {
      id: 'm6',
    ...
    users: [{
      ...
      id: 'u8',
      name: 'Borja',
      imageUri: 'https://homepages.cae.wisc.edu/~ece533/images/sails.png',
    }],
    lastMessage: {
      id: 'm7',
      content: 'How are you doing?',
